...
This rulle will create an OCI archive (container image) that is used to generate a disk image (.qcow2, .img, etc).

.. csv-table:: 
   :header: "field", "Required", "Default Value", "Description"
   :widths: 20, 10, 25, 40

   "distro", "false", "autosd10", "Target distro to use (autosd10, autosd10-sig)"
   "arch", "false", "x86_64", "Target image architecture (x86_64, aarch64)"
...
.. code-block:: starlark
   ...
   load("@os_autosd//toolchain/aib:defs.bzl", "aib_script", "aib_build_builder", "aib_build_builder, "aib_build_disk")
...
- No cross arch. support: The generated image needs to match the arch. of the system that is running Bazel;
